...
/*   Updated: 2026/01/10 14:21:07 by mrouissy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScavTrap::attack(const std::string& target)
{
    ...
    _ep--;
    std::cout << _name << " attacks " << target << ", causing " << _dmg << " points of damage! ( stats " << _hp << " HP, " << _ep << " EP, " << _dmg << " DMG) overwtited" << std::endl;
}
